...
-- Grant INSERT, UPDATE, DELETE on PAT_TOKENS table (needed for CRUD operations)
GRANT INSERT, UPDATE, DELETE ON TABLE API_PROXY.APP.PAT_TOKENS TO ROLE API_PROXY_SERVICE_ROLE;
